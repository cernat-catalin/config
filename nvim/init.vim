...
Plug 'jiangmiao/auto-pairs'             " auto close parentheses and quotes
Plug 'vim-airline/vim-airline'          " bottom status bar
Plug 'vim-airline/vim-airline-themes'
Plug 'scrooloose/nerdcommenter'         " comments
Plug 'scrooloose/nerdtree'              " file_system explorer
...
" Fix auto-pairs bug, which waits after inserting less than symbol '<'
